 ...
 * @author JG uniCenta
 */
public class JPaymentCard extends javax.swing.JPanel implements JPaymentInterface {
    ...
    public JPaymentCard(JPaymentNotifier notifier) {
    ...
    public PaymentInfo executePayment() {
        return new PaymentInfoTicket(totalPayed, "card");      
    }
